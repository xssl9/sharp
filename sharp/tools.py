...
Голосовые фразы проходят локальный фильтр обращения «Шарп». Не проси пользователя
нажимать клавиши: для новой команды достаточно сказать «Шарп» и саму команду.
